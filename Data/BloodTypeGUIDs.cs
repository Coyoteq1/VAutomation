...
namespace CrowbaneArena.Data
{
    ...
    public static class BloodTypeGUIDs
    {
        ...
        /// <summary>
        /// Gets all available blood type names
        /// </summary>
        public static IEnumerable<string> GetBloodTypes()
        {
            return _bloodTypeMap.Keys;
        }

        /// <summary>
        /// Gets all available blood type names (alias for GetBloodTypes)
        /// </summary>
        public static IEnumerable<string> BloodTypes => _bloodTypeMap.Keys;

        /// <summary>
        /// Try to get a blood type by name
        /// </summary>
        public static bool TryGetBloodType(string bloodType, out PrefabGUID? guid)
        {
            guid = null;
            if (string.IsNullOrEmpty(bloodType))
                return false;
                
            if (_bloodTypeMap.TryGetValue(bloodType.ToLower(), out var foundGuid))
            {
                guid = foundGuid;
                return true;
            }
